...
class ConfigFileHandler(DefaultValues):
    ...
    def _read_config(self, file_path_config):
        ...
        community_key_options = {
            "genomes_total", 'num_real_genomes', 'max_strains_per_otu', 'ratio', 'equally_distributed_strains',
            'input_genomes_to_zero', 'log_mu', 'log_sigma', 'gauss_mu', 'gauss_sigma'}
        ...
        for community_section in community_sections:
            ...
            path_to_abundance_file = self._config.get_value('path_to_abundance_file', community_section, is_path=True, silent=True)
            ...
            assert path_to_abundance_file is None or isinstance(path_to_abundance_file, str)
    ...
    def _stream_communities(self, output_stream=sys.stdout):
        ...
        for community in self._list_of_communities:
            ...
            output_stream.write("path_to_abundance_file={}\n".format(community.path_to_abundance_file or ""))
