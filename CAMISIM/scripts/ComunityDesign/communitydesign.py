...
class Community(Validator):
    ...
    def __init__(
            ...
            file_path_genome_locations, file_path_gff_locations, path_to_abundance_file, ratio, mode,
        ...
        self.path_to_abundance_file = None
        if path_to_abundance_file is not None:
            self.path_to_abundance_file = self.get_full_path(path_to_abundance_file)
...
#        if not self.equally_distributed_strains == ()
        ...
        if self.path_to_abundance_file and not self.validate_file(self.path_to_abundance_file):
            return False
...
class CommunityDesign(GenomePreparation):
    ...
    def design_community(
        ...
        #print('\n\nThis is list_of_drawn_genome_id initialized with get_drawn_genome_id(): \n')
        ...
        if community.simulate_strains:
            ...
            #print('\n\nThis is list_of_drawn_genome_id inside if: \n')
            #print(list_of_drawn_genome_id)
            #print('\n\n\n')
        ...
        list_of_distributions = population_distribution.get_lists_of_distributions(
            ...
            abundance_file_path=community.path_to_abundance_file,
        ...
        #print('\n\nThis is the dictionary genome_id_to_distributions: \n')
        #print(genome_id_to_distributions)
        #print('\n\n\n')
